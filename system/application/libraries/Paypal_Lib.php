...
class Paypal_Lib {
	...
	function paypal_auto_form() 
	{
		...
		echo "<link rel='stylesheet'  href='/template/css/main.css' type='text/css' /> \n";
		echo '<body onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
		#echo '<body>';
		echo '<div style="width: 600px; margin-left: auto; margin-right: auto"><br /><br /><h1>Please Wait...</h1><p>Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
